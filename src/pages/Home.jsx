...
const Home = () => {
  ...
  const [castleScale, castlePosition] = adjustIslandForScreenSize();
  const [moonScale, moonPosition] = adjustMoonForScreenSize();
  const snowScale  = adjustSnowForScreenSize();

  return (
    <section className="w-100 h-screen relative bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-slate-700  to-slate-900">
      <Canvas
